...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, Integer.class, "regionId", null, true, false, true, "INTEGER", 10, 0, null, null, false, null, null, null, "memberAddressList", CDef.DefMeta.Region, false);
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, null, String.class, "regionName", null, false, false, true, "VARCHAR", 50, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.derby.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.derby.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.derby.dbflute.exbhv.RegionBhv"; }
