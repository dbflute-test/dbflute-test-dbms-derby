...
public abstract class BsPurchase extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
     ...
     * @param purchaseDatetime : +UQ, IX+, NotNull, TIMESTAMP(29, 9). (NotNull)
     */
    ...
    /**
     * [get] PURCHASE_DATETIME: {+UQ, IX+, NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [set] PURCHASE_DATETIME: {+UQ, IX+, NotNull, TIMESTAMP(29, 9)} <br>
