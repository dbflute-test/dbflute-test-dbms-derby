...
import org.docksidestage.derby.dbflute.allcommon.EntityDefinedCommonColumn;
...
public abstract class BsMemberWithdrawal extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] MEMBER_ID: {PK, IX, NotNull, INTEGER(10), FK to MEMBER} <br>
    ...
    /**
     * [set] MEMBER_ID: {PK, IX, NotNull, INTEGER(10), FK to MEMBER} <br>
    ...
    /**
     * [get] WITHDRAWAL_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [set] WITHDRAWAL_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [get] REGISTER_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [set] REGISTER_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [get] UPDATE_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
    ...
    /**
     * [set] UPDATE_DATETIME: {NotNull, TIMESTAMP(29, 9)} <br>
