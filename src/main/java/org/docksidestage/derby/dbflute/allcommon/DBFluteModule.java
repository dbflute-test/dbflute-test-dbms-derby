...
public class DBFluteModule implements Extension {
    ...
    protected void setupBehaviors(final AfterBeanDiscovery event, final BeanManager beanManager) {
        ...
        typeList.add(MemberFollowingBhv.class);
    ...
    protected void initializeDBFlute() {
        new org.docksidestage.derby.dbflute.allcommon.DBFluteInitializer();
    }
     ...
     */
    protected DBFluteBean<org.docksidestage.derby.dbflute.allcommon.ImplementedInvokerAssistant> newDBFluteBeanOfInvokerAssistant(final BeanManager beanManager) {
        return new DBFluteBean<org.docksidestage.derby.dbflute.allcommon.ImplementedInvokerAssistant>(
                beanManager, org.docksidestage.derby.dbflute.allcommon.ImplementedInvokerAssistant.class, InvokerAssistant.class) {
            @Override
            protected void postInject(final org.docksidestage.derby.dbflute.allcommon.ImplementedInvokerAssistant instance) {
     ...
     * @return The new-created DBFlute bean. (NotNull)
     */
    protected DBFluteBean<org.docksidestage.derby.dbflute.allcommon.ImplementedCommonColumnAutoSetupper> newDBFluteBeanOfCommonColumnAutoSetupper(final BeanManager beanManager) {
        return new DBFluteBean<org.docksidestage.derby.dbflute.allcommon.ImplementedCommonColumnAutoSetupper>(beanManager, org.docksidestage.derby.dbflute.allcommon.ImplementedCommonColumnAutoSetupper.class, CommonColumnAutoSetupper.class);
    }
